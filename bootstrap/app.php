...
#El arranque carga .env, configura la ruta base, registra el autoload de Composer o 
#el autoload de respaldo, establece la zona horaria y crea la sesión con parámetros seguros para el entorno local.
...
//Detecta automaaticamente la carpeta base cuando el proyecto esta denro de htdocs
